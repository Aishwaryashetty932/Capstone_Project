...
public class PurchaseMonitorTest extends BaseClass {
    ...
    public void purchaseMonitorTest() throws Exception {
        ...
        try {
            // Step 2: Select Category as Monitors
            String selectedCategory = homePage.selectCategory("Monitors");
            ScreenshotUtil.takeScreenshot(driver, "Category_Selected");
            ReportManager.logPass("Selected Category: " + selectedCategory);
        } catch (Exception e) {
            ReportManager.logFail("Failed to select category 'Monitors': " + e.getMessage());
            throw e;
        }

        try {
            // Step 3: Select Product Apple Monitor 24
            String selectedProduct = productPage.addProductToCart("Apple monitor 24");
        ...
        try {
            ...
            String purchaseID = checkoutPage.completePurchase("Aishwarya", "India", "Bangalore", "123456789", "07", "2026");
